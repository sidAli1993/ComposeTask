package com.sid_ali_tech.composetask.ui.screens.auth
...
import com.sid_ali_tech.composetask.R
import com.sid_ali_tech.composetask.routes.Routes
import com.sid_ali_tech.composetask.ui.theme.ComposeTaskTheme
            ...
            Button(
                onClick = {
                    if (username.value.text.isNotEmpty()){
                        navController.navigate(route = Routes.DashboardScreen.getParams(username.value.text))
                    }else{
